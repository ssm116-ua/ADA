...
#Análisis y diseño algoritmos (GII - I2ADE) 2024-25
...
[ $quiet -eq 0 ] && echo -n "Tiempo de proceso (seg.): "; [ $ret -eq 124 ]  && echo -n "TIMEOUT(${MAX_TIME} seg.)" || echo -n ${elapsed_t}
case $ret in
...
[[ $num_fits -ne 6 ]] && { echo "Error: El número de ajustes mmcc que se piden son exactamente 6." >> ${err_file}; RETURN_CODE=$((RETURN_CODE |= 1)); exit 1; }
